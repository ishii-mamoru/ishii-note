...
<html lang="en">
  <head>
    ...
    <link href="/admin-template/css/sb-admin-2.css" rel="stylesheet">
    <!-- Custom styles for this page -->
    <link href="/admin-template/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.index') }}">
          ...
          <div class="sidebar-brand-text mx-3">技術メモ</div>
        </a>
        <!-- Divider -->
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="{{ route('dashboard') }}" role="button">
                  <span class="mr-2 d-none d-lg-inline text-gray-600 small">ダッシュボード</span>
                </a>
              </li>
            </ul>
          </nav>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; 技術メモ 2022</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
    ...
    <!-- Page level plugins -->
    <script src="/admin-template/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="/admin-template/vendor/datatables/dataTables.bootstrap4.min.js"></script>
